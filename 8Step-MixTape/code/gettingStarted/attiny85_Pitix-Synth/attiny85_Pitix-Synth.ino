...
//#define FS (80000) // @FCPU=9.6Mhz
#define FS (80000/2) // @FCPU=9.6Mhz
...
int main(void)
{
...

	{
		...
		if(wert>10) {wave=RECTANGLE;RectanglePwmValue=0x02;}
                if(wert>15) {wave=RECTANGLE;RectanglePwmValue=0x04;}
                if(wert>20) {wave=RECTANGLE;RectanglePwmValue=0x06;}
                if(wert>25) {wave=RECTANGLE;RectanglePwmValue=0x09;}
		if(wert>30) {wave=RECTANGLE;RectanglePwmValue=0x12;}
                if(wert>35) {wave=RECTANGLE;RectanglePwmValue=0x15;}
                if(wert>40) {wave=RECTANGLE;RectanglePwmValue=0x20;}
                if(wert>45) {wave=RECTANGLE;RectanglePwmValue=0x26;}
                if(wert>50) {wave=RECTANGLE;RectanglePwmValue=0x32;}			
		if(wert>55) {wave=RECTANGLE;RectanglePwmValue=0x40;}			
		if(wert>60) {wave=RECTANGLE;RectanglePwmValue=0x50;}
                if(wert>65) {wave=RECTANGLE;RectanglePwmValue=0x64;}	
		if(wert>90) {wave=RECTANGLE;RectanglePwmValue=0x80;}	
		if(wert>127) wave=SAWTOOTH;	
		if(wert>170) wave=TRIANGLE;
